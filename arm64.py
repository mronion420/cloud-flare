import os
os.system("wget https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-linux-arm64")
os.system("chmod 777 cloudflared-linux-arm64")
os.system("mv cloudflared-linux-arm64 cf")
